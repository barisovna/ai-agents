...
- НИКОГДА не обрывай ответ на полуслове. Если ответ длинный — доведи до логического конца.
- Если чувствуешь, что ответ будет очень длинным — разбей на чёткие блоки, но ВСЕГДА заверши мысль.
