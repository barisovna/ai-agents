            ...
            {chats.map((chat) => (
              ...
              >
                ...
                <button
                  ...
                  className="opacity-0 group-hover:opacity-100 w-7 h-7 rounded flex items-center justify-center hover:bg-red-100 dark:hover:bg-red-900/30 text-zinc-400 hover:text-red-500 transition-all shrink-0"
                  title="Удалить чат"
                >
